  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "CoreLab — Reformer & Barre Pilates Studio" },
      {
        ...
        content:
          "Slow, deliberate reformer pilates. Six mats per class. Warm wood, arched windows, golden light.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/57ad8716-6118-42a8-bd8b-a59befa6a004/id-preview-57387ca3--c808f77e-87ef-451f-aadd-2d19ead91c6f.lovable.app-1783142179450.png",
      },
      {
        name: "twitter:image",
        content:
